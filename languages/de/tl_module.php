 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_module']['ticker_direction']	= array('Orientierung', 'Wählen Sie ob Vertikal oder Horizontal gescrollt werden soll.');
$GLOBALS['TL_LANG']['tl_module']['ticker_pause']		= array('Pausieren erlauben', 'Zeigt Steuerelemente zum pausieren/fortsetzen des Tickers.');
$GLOBALS['TL_LANG']['tl_module']['ticker_width']		= array('Breite', 'Geben Sie die Breite des Tickers in Pixel ein.');
 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_module']['ticker_legend']		= 'Ticker Einstellungen';
...
$GLOBALS['TL_LANG']['tl_module']['fade'] 				= 'Überblenden';
